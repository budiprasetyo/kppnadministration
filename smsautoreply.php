...
<head>
  ...
  <title>SMS Gateway KPPN Semarang II</title>
...
<table width="100%" align="center">
  <tr bgcolor="#C5C5C5">
    ...
    <td align="center"><h1>SMS Gateway Server KPPN Semarang II is Running</h1></td>
  </tr>
...
include "config/fungsi_seo.php";
  ...
  while($hasil=mysql_fetch_array($queri))
       {
        $receive=$hasil[ReceivingDateTime];
	$sender =$hasil[SenderNumber];
	$coding =$hasil[Coding];
	$text   =$hasil[TextDecoded];
